      ...
      <div className="flex justify-center items-center flex-wrap gap-8">
        ...
        <div>
          ...
          <div class="flex justify-center gap-6 mt-4">
            <Link href="https://instagram.com/tharshen_sb?igshid=MzMyNGUyNmU2YQ==">
              <div class="transition flex items-center justify-center py-3 rounded-lg tablet:w-[180px] phone:w-[150px] bg-gradient-to-r from-indigo-700 via-red-500 to-orange-500 hover:bg-gradient-to-r hover:from-indigo-800 hover:via-red-600 hover: hover:to-orange-600">
            ...
            <Link href="https://www.linkedin.com/in/tharshen-surianbalan-205a94256/">
              <div class="transition flex justify-center py-3 rounded-lg tablet:w-[180px] phone:w-[150px] items-center bg-blue-500 hover:bg-blue-600">
