    ...
    <section className="">
        ...
        <div className="flex flex-wrap justify-center gap-8 mt-10 mx-8">
            ...
            <div className="bg-yellow-500 text-black font-bold text-sm rounded-xl w-24 text-center py-1 my-2">In Progress</div>
                ...
                <Link href="https://github.com/Tharshen2124/Restaurant-frontend"><div className="transition text-blue-400 hover:text-blue-500 active:text-blue-600 underline mt-3">Frontend Repository Link </div></Link>
                <Link href="https://github.com/Tharshen2124/Restaurant-api"><div className="transition text-blue-400 hover:text-blue-500 active:text-blue-600 underline mt-3">Backend Repository Link</div></Link>
            </div>
            <div className="w-[500px] py-5 px-10 rounded-xl bg-gradient-to-r from-gray-800 via-gray-900 to-black shadow-lg">
            <div className="bg-yellow-500 text-black font-bold text-sm rounded-xl w-24 text-center py-1 my-2">In Progress</div>
            ...
            <div className="bg-yellow-500 text-black font-bold text-sm rounded-xl w-24 text-center py-1 my-2">In Progress</div>
                ...
                <Link href="https://github.com/Tharshen2124/quiz-app"><div className="transition text-blue-400 hover:text-blue-500 active:text-blue-600 underline mt-3">Repository Link</div></Link>
            </div>
            <div className="w-[500px] py-5 px-10 rounded-xl bg-gradient-to-r from-gray-800 via-gray-900 to-black shadow-lg">
            <div className="bg-green-500 text-black font-bold text-sm rounded-xl w-24 text-center py-1 my-2">Completed</div>
                ...
                <Link href="https://github.com/Tharshen2124/File-sorter"><div className="transition text-blue-400 hover:text-blue-500 active:text-blue-600 underline mt-3">Repository Link</div></Link>
            </div>
        </div>
